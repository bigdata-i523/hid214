...
\cite{nocitationsused}

\TODO{student modified the format by removing bibtex}

\TODO{

ALL CITATION need to use cite 

[1]Gómez M Á, Silva R, Lorenzo A, et al. Exploring the effects of substituting basketball players in high-level teams.[J]. Journal of Sports Sciences, 2016, Ahead of print:1-8.\\
